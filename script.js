...
.then(data => {
    ...
    otherManhwas.forEach(manhwa => {
        ...
        div.innerHTML = `
            <a href="/read/${manhwa.title.replace(/\s+/g, '-')}"><img src="${manhwa.cover_image}" style="width: 150px; height: 200px; object-fit: cover; display: block; margin: 2px auto;"></a>
    ...
    if (latestManhwa) {
        ...
        div.style.cssText = "display: flex; flex-direction: column; align-items: center; width: 100%; max-width: 200px; max-height: 270px; padding: 5px; box-sizing: border-box; flex: 1;";
        div.innerHTML = `
            <a href="/read/${latestManhwa.title.replace(/\s+/g, '-')}"><img src="${latestManhwa.cover_image}" style="width: 150px; height: 200px; object-fit: cover; display: block; margin: 2px auto;"></a>
            ...
            <a href="/read/${latestManhwa.title.replace(/\s+/g, '-')}/chapter-${latestManhwa.maxChapter}" style="text-align: center; margin: 2px 0; flex: 1;">
