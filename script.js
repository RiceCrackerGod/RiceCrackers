...
.then(data => {
    ...
    otherManhwas.forEach(manhwa => {
        ...
        div.innerHTML = `
            ...
            <a href="/read/${manhwa.title.replace(/\s+/g, '-').toLowerCase()}/chapter-${manhwa.maxChapter}" style="text-align: center; margin: 2px 0; flex: 1;">
    ...
    if (latestManhwa) {
        ...
        div.innerHTML = `
            ...
            <a href="/read/${latestManhwa.title.replace(/\s+/g, '-').toLowerCase()}/chapter-${latestManhwa.maxChapter}" style="text-align: center; margin: 2px 0; flex: 1;">
