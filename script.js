...
.then(data => {
    ...
    if (latestManhwa) {
        ...
        div.style.cssText = "display: flex; flex-direction: column; align-items: center; width: 100%; max-width: 200px; max-height: 270px; padding: 5px; box-sizing: border-box; flex: 1;";
        div.innerHTML = `
            <img href="/read/${latestManhwa.title.replace(/\s+/g, '-')}" src="${latestManhwa.cover_image}" style="width: 150px; height: 200px; object-fit: cover; display: block; margin: 2px auto;">
