...
def main():
    ...
    source_html = "RiceCrackers/read/0zero.html"    # Your source HTML file
    source_folder = "RiceCrackers/read/0zero"  # Your source folder
    list_file = "RiceCrackers/manager/list.txt"          # File containing list of names
